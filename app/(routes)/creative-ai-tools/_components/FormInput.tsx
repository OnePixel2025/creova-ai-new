...
const AvatarList = [
    ...
    {
        name: 'Avatar 3',
        imageUrl: 'https://ik.imagekit.io/szigv9obd/saudi-man.jpg?updatedAt=1761268056816'
    },
    {
        name: 'Avatar 4',
        imageUrl: 'https://ik.imagekit.io/szigv9obd/hihab-women.avif?updatedAt=1761268266580'
    },
    {
        name: 'Avatar 5',
    ...
    {
        name: 'Avatar 7',
        imageUrl: 'https://ik.imagekit.io/szigv9obd/saudi-women.jpg?updatedAt=1761268409692'
    },
    {
        name: 'Avatar 8',
        imageUrl: 'https://ik.imagekit.io/szigv9obd/black-man.avif?updatedAt=1761268494153'
    },
...
function FormInput({ onHandleInputChange, OnGenerate, loading, enableAvatar, isVideoGeneration = false }: Props) {
    ...
    return (
        <div className='p-7 border rounded-2xl'>
            ...
            <Button
                disabled={loading}
                className='mt-5 w-full text-black bg-gradient-to-r from-[#CCFF02] to-[#02BCCC] font-bold hover:from-[#A6E200] hover:to-[#0299A3]' onClick={OnGenerate}>
                {loading ? <Loader2Icon className='animate-spin' /> : <Sparkles />}Generate </Button>
            <h2 className='mt-1 text-sm opacity-35 text-center'>
                {isVideoGeneration 
                    ? '4 Credits to Generate' 
                    : enableAvatar 
                        ? '5 Credits to Generate' 
                        : '2 Credits to Generate'
                }
            </h2>
        </div>
    )
